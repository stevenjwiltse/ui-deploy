...
/**
 * Search users by username (auth required)
 */
export const searchUsersApiV1UsersSearchGet = <ThrowOnError extends boolean = false>(options: Options<SearchUsersApiV1UsersSearchGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchUsersApiV1UsersSearchGetResponse, SearchUsersApiV1UsersSearchGetError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const updateUserPassword = <ThrowOnError extends boolean = false>(options: Options<UpdateUserPasswordData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, UpdateUserPasswordError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
